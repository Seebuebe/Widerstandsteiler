...
void Ecalc::calc(){
  ...
  for(int i = 0; i < seriesLookup[series]; i++){
    for(int i1 = 0; i1 < seriesLookup[series]; i1++){
...
double Ecalc::getR(int number){
  int s = seriesLookup[series];
  switch(s) {
    case 3: return e3[number]; break;
    case 6: return e6[number]; break;
    case 12: return e12[number]; break;
    case 24: return e24[number]; break;
    case 48: return e24[number]; break;
    case 96: return e96[number]; break;
    case 192: return e192[number]; break;
  }
  return 0;
}
